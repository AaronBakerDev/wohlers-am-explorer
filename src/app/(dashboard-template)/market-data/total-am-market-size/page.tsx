...
export default function TotalAMMarketSizePage() {
  ...
  const dataset = 'total-am-market-size'
  const config = {
    name: 'Total AM Market Size',
    description: 'Market size forecasts and historical data for the additive manufacturing industry'
  }
  ...
  return (
    <div className="h-full flex flex-col bg-background">
      ...
      <div className="flex-1 p-6 overflow-auto">
        ...
        {!loading && !error && csvData.length > 0 && <div>{view === 'table' ? <GenericTableLayout data={csvData} dataset={dataset} /> : <TotalMarketSizeLayout />}</div>}
