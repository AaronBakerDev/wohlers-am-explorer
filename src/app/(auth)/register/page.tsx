...
import { upsertUserProfile } from '@/lib/user/client'
...
function RegisterForm() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If auto-confirm is enabled, user may be logged in; ensure profile exists
      try {
        await upsertUserProfile({ full_name: fullName, role: 'basic' as const })
      } catch (_err) {}
      // Redirect to login with notice if confirmation needed
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Access the AM Market Explorer platform</p>
          </div>
